...
Esta árvore é a base de publicação do Crypto Guard 1.6.0 / CGUARD v4.
...
## Obrigatório antes de publicar v1.6.0
...
4. Confirme que `package-lock.json` está commitado e que `package.json` está em `1.6.0`.
