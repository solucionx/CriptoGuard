...
A v1.6.5 cria e lê somente o formato CGUARD v4. O formato foi desenhado para criptografia local por senha de arquivos e pastas. Transferência E2E entre usuários não faz parte desta versão.
