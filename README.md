...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Vers%C3%A3o-1.6.1-003061?style=for-the-badge" alt="Versão 1.6.1">
</p>
...
**Crypto Guard 1.6.1** consolida o formato **CGUARD v4** e restaura a integração do Windows com arquivos `.cguard`. O aplicativo criptografa e descriptografa arquivos e pastas localmente; arquivos e senhas não são enviados para servidores durante o fluxo criptográfico.
